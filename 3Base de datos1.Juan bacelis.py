...
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("Juan", 18))
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("Josmar", 18))
...
alumno2=conexion.execute("select*from alumnos where nombre ='Josmar'")
