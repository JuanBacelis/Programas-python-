...
def nuevo_alumno(event=None):
    ...
    #crear la etiqueta y el campo de entrada para el sexo
    name_label=tk.Label(ventana_nuevo_alumno,text= "Sexo:")
    name_label.grid(row=0,column=0,padx=(10,0) )

    sex_entry=tk.Entry(ventana_nuevo_alumno)
    sex_entry.grid(row=0,column=1,padx=(0,10))
    ...
    submit_button.grid(row=2, column=0, columnspan=2, pady=20, padx=20)
...
registros_lb.pack(pady=50, padx=50)
