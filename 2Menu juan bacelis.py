...
class MenuScreen(tk.Frame):
    def __init__(self, master):
        ...
        self.file_menu. add_command (label="Eliminar archivo",command=self.delete_file)
        ...
        self.label = tk.Label(self, text="¡Bienvenido,presiona el boton!")
        self.label.pack(pady=30)
        self.button = tk.Button(self, text="Presioname bro", command=self.press_button)
        self.button.pack()
        self.button=tk.Button(self,text="Iniciar",command=self.press_button)
        self.button.pack()
